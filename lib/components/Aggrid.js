...
var AgGrid = function (_a) {
    ...
    return (_jsx("div", __assign({ className: "ag-theme-alpine" }, { children: _jsx(AgGridReact, { columnDefs: columnDefs, rowData: rowData, pagination: pagination, paginationPageSize: paginationPageSize, headerCheckboxSelection: headerCheckboxSelection, headerCheckboxSelectionFilteredOnly: headerCheckboxSelectionFilteredOnly, checkboxSelection: checkboxSelection, onFilterChanged: onFilterChanged, rowSelection: rowSelection, 
